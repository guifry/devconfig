"""Generate .windsurf/rules/*.md format output."""

from ..models import Block


def generate_windsurf_rules(blocks: list[Block]) -> str:
    """Generate Windsurf rules .md content from blocks.
