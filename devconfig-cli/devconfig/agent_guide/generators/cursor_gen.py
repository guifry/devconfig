"""Generate .cursor/rules/*.mdc format output."""

from ..models import Block


def generate_cursor_rules(blocks: list[Block]) -> str:
    """Generate Cursor rules .mdc content from blocks.
    ...
    lines = [
        "---",
        "description: Project coding guidelines from devconfig",
        "alwaysApply: true",
        "---",
        "",
        "# Project Guidelines",
